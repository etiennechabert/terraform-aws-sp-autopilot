...
def test_fetch_compute_sp_recommendation_success(mock_ce_client, mock_config):
    ...
    result = recommendations._fetch_compute_sp_recommendation(mock_ce_client, mock_config, 'THIRTY_DAYS')
...
def test_fetch_compute_sp_recommendation_insufficient_data(mock_ce_client, mock_config):
    ...
    result = recommendations._fetch_compute_sp_recommendation(mock_ce_client, mock_config, 'SEVEN_DAYS')
...
def test_fetch_database_sp_recommendation_success(mock_ce_client, mock_config):
    ...
    result = recommendations._fetch_database_sp_recommendation(mock_ce_client, mock_config, 'THIRTY_DAYS')
...
def test_fetch_database_sp_recommendation_insufficient_data(mock_ce_client, mock_config):
    ...
    result = recommendations._fetch_database_sp_recommendation(mock_ce_client, mock_config, 'SEVEN_DAYS')
...
def test_fetch_database_sp_recommendation_api_error(mock_ce_client, mock_config):
    ...
    with pytest.raises(ClientError):
        recommendations._fetch_database_sp_recommendation(mock_ce_client, mock_config, 'THIRTY_DAYS')
...
def test_fetch_sagemaker_sp_recommendation_success(mock_ce_client, mock_config):
    ...
    result = recommendations._fetch_sagemaker_sp_recommendation(mock_ce_client, mock_config, 'THIRTY_DAYS')
...
def test_fetch_sagemaker_sp_recommendation_insufficient_data(mock_ce_client, mock_config):
    ...
    result = recommendations._fetch_sagemaker_sp_recommendation(mock_ce_client, mock_config, 'SEVEN_DAYS')
...
def test_fetch_sagemaker_sp_recommendation_api_error(mock_ce_client, mock_config):
    ...
    with pytest.raises(ClientError):
        recommendations._fetch_sagemaker_sp_recommendation(mock_ce_client, mock_config, 'THIRTY_DAYS')
