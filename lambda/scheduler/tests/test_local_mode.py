...
os.environ.setdefault("COVERAGE_TARGET_PERCENT", "99")
...
os.environ.setdefault("TARGET_STRATEGY_TYPE", "dynamic")
os.environ.setdefault("SPLIT_STRATEGY_TYPE", "fixed_step")
os.environ.setdefault("FIXED_STEP_PERCENT", "10")
