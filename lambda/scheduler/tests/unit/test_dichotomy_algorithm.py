...
class TestCalculateDichotomyPurchasePercent:
    ...
    def test_different_max_purchase_percents(self):
        ...
        assert calculate_dichotomy_purchase_percent(50.0, 90.0, 100.0, 1.0) == pytest.approx(25.0)

        # At 50%, target 90%, max 25%
        # Try 25%: 50 + 25 = 75 <= 90, use 25%
        assert calculate_dichotomy_purchase_percent(50.0, 90.0, 25.0, 1.0) == pytest.approx(25.0)
    ...
    def test_different_targets(self):
        ...
        assert calculate_dichotomy_purchase_percent(50.0, 80.0, 50.0, 1.0) == pytest.approx(25.0)
        ...
        assert calculate_dichotomy_purchase_percent(50.0, 60.0, 50.0, 1.0) == pytest.approx(6.2)
    ...
    def test_progression_sequence(self):
        ...
        assert calculate_dichotomy_purchase_percent(0.0, 90.0, 50.0, 1.0) == pytest.approx(50.0)

        # Month 2: At 50%, target 90% -> 50 + 25 = 75 <= 90, use 25%
        assert calculate_dichotomy_purchase_percent(50.0, 90.0, 50.0, 1.0) == pytest.approx(25.0)

        # Month 3: At 75%, target 90% -> 75 + 12.5 = 87.5 <= 90, use 12.5%
        assert calculate_dichotomy_purchase_percent(75.0, 90.0, 50.0, 1.0) == pytest.approx(12.5)

        # Month 4: At 87.5%, target 90% -> halve to 1.5625% -> round to 1.6%
        assert calculate_dichotomy_purchase_percent(87.5, 90.0, 50.0, 1.0) == pytest.approx(1.6)
...
class TestCalculatePurchaseNeedDichotomy:
    ...
    def test_compute_sp_large_gap(self):
        ...
        assert result[0]["hourly_commitment"] == pytest.approx(5.0)  # 50% of $10
    ...
    def test_compute_sp_medium_gap(self):
        ...
        assert result[0]["hourly_commitment"] == pytest.approx(2.0)  # 25% of $8
    ...
    def test_compute_sp_small_gap(self):
        ...
        assert result[0]["hourly_commitment"] == pytest.approx(0.08)  # 1.6% of $5
    ...
    def test_database_sp_purchase(self):
        ...
        assert result[0]["hourly_commitment"] == pytest.approx(7.5)  # 50% of $15
    ...
    def test_sagemaker_sp_purchase(self):
        ...
        assert result[0]["hourly_commitment"] == pytest.approx(10.0)  # 50% of $20
    ...
    def test_multiple_sp_types_enabled(self):
        ...
        assert compute_plan["hourly_commitment"] == pytest.approx(2.5)
        assert compute_plan["purchase_percent"] == pytest.approx(25.0)

        # Database: Gap 90% -> purchase 50% of $5 = $2.50
        assert database_plan["hourly_commitment"] == pytest.approx(2.5)
        assert database_plan["purchase_percent"] == pytest.approx(50.0)

        # SageMaker: Gap 15% -> purchase 12.5% of $8 = $1.00
        assert sagemaker_plan["hourly_commitment"] == pytest.approx(1.0)
        assert sagemaker_plan["purchase_percent"] == pytest.approx(12.5)
    ...
    def test_different_max_purchase_percents_in_integration(self):
        ...
        assert result[0]["hourly_commitment"] == pytest.approx(2.5)  # 25% of $10
        assert result[0]["purchase_percent"] == pytest.approx(25.0)
    ...
    def test_progression_simulation(self):
        ...
        assert result[0]["purchase_percent"] == pytest.approx(25.0)
        assert result[0]["hourly_commitment"] == pytest.approx(25.0)
        ...
        assert result[0]["purchase_percent"] == pytest.approx(12.5)
        assert result[0]["hourly_commitment"] == pytest.approx(12.5)
