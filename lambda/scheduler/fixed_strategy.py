...
def _process_sp_type_fixed(
    ...
    """Process a single SP type for fixed strategy."""
...
def calculate_purchase_need_fixed(
    ...
    for sp_type in sp_types:
        plan = _process_sp_type_fixed(
            sp_type, config, spending_data, target_coverage, max_purchase_percent
        )
        if plan:
