"""Purchaser tests configuration - imports shared fixtures."""
...
aws_get_savings_plans_coverage_grouped = (
    _shared_conftest.aws_get_savings_plans_coverage_grouped
)
aws_get_savings_plans_coverage_history = (
    _shared_conftest.aws_get_savings_plans_coverage_history
)
