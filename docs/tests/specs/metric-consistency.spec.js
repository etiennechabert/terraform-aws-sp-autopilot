...
// Real reporter output data for testing with custom URL data
...
test.describe('Strategy Preset Tests with Custom URL Data', () => {
  test('Prudent strategy matches with custom URL data', async ({ page }) => {
    ...
    const cardSavings = await page.locator('#strategy-too-prudent-savings').textContent();
    const cardSavingsPct = await page.locator('#strategy-too-prudent-savings-pct').textContent();
    const topSavings = await page.locator('#metric-savings').textContent();
    const topSavingsPct = await page.locator('#metric-savings-pct').textContent();
  ...
  test('Min-Hourly strategy matches with custom URL data', async ({ page }) => {
    await page.goto(`index.html?usage=${REPORTER_URL_DATA}`);
    await page.waitForSelector('.metrics-row');
    await page.waitForTimeout(1000);
  ...
  test('Balanced strategy matches with custom URL data', async ({ page }) => {
    await page.goto(`index.html?usage=${REPORTER_URL_DATA}`);
    await page.waitForSelector('.metrics-row');
    await page.waitForTimeout(1000);
  ...
  test('Risky strategy matches with custom URL data', async ({ page }) => {
    await page.goto(`index.html?usage=${REPORTER_URL_DATA}`);
    await page.waitForSelector('.metrics-row');
    await page.waitForTimeout(1000);
    ...
    const cardSavings = await page.locator('#strategy-aggressive-savings').textContent();
    const cardSavingsPct = await page.locator('#strategy-aggressive-savings-pct').textContent();
    const topSavings = await page.locator('#metric-savings').textContent();
    const topSavingsPct = await page.locator('#metric-savings-pct').textContent();
  ...
  test('Aggressive strategy matches with custom URL data', async ({ page }) => {
    await page.goto(`index.html?usage=${REPORTER_URL_DATA}`);
    await page.waitForSelector('.metrics-row');
    await page.waitForTimeout(1000);
