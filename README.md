...
- **`static`** — Sets a fixed hourly commitment target (`commitment` in $/h). The target is converted to a coverage percentage based on your actual spend, then combined with your chosen split strategy. Useful when you know exactly how much you want to commit.
